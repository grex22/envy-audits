                    ...
                    <div class="row-fluid">
                      ...
                      <div class="span12">
                        ...
                        <div class="row-fluid report_header padded">
                          ...
                          <div class="span3">
                            <div class="btn-group pull-right more_button_padding data_view_buttons">
                              ...
                              <button class="glow right active" data-url="client-report-detail-dp.php">Day Part</button>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="span9 report_large_col">
                         <h4 class="more_bottom_margin">Score by Day Part: </h4>
                          <div class="row-fluid">
                            ...
                            <div class="chart">
                              <div class="tab-content flotchartcontainer">
                                <div class="tab-pane active" id="overall">
                                  <div class="row-fluid">
                                    <div id="daypart" class="span12 flot_fix" style="max-width:50%"></div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <?php for($i=1; $i<15; $i++){ $pf = rand(0,2); ?>
                              <tr class="<?php $pf ? print"pass" : print"fail"; ?>">
                                ...
                                <td>Cashier<?php if($i == 1){ ?>
                                    <br>Quality Control
                                  <?php } ?></td>
                                <td><strong><?php $i <= 7 ? print "Lunch" : print "Dinner"; ?></strong></td>
                                <td>7/13/13</td>
                                <td>3:32 pm EST</td>
                                <td>Braintree</td>
